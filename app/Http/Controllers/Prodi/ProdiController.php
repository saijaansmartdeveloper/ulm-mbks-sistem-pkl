    ...
    public function getProdi()
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('action', function ($data) {
                $action = '<a href=' . route('prodi.edit', ['id' => $data->uuid]) . ' class="btn btn-sm btn-primary" >Ubah</a>';
                $action .= \Form::open(['url' => route('prodi.destroy', ['id' => $data->uuid]), 'method' => 'delete', 'style' => 'float:right']);
