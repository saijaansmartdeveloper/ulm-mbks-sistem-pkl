    ...
    public function getUser()
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('action', function ($data) {
                $action   = '<a href=' . route('user.edit', ['id' => $data->uuid]) . ' class="btn btn-sm btn-primary" >Ubah</a>';
                $action  .= '<a href=' . route('user.show', ['id' => $data->uuid]) . ' class="btn btn-sm btn-info" >Show</a>';
                $action  .= \Form::open(['url' => route('user.destroy', ['id' => $data->uuid]), 'method' => 'delete', 'style' => 'float:right']);
