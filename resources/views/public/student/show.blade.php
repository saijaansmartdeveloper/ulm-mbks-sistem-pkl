    ...
    <div class="card-body">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-12 mb-1">
                <img src="{{ $data->foto_mahasiswa == null ? asset('img/person.png') : asset('storage/' . $data->foto_mahasiswa) }}"
...
<div class="card mb-3">
    <div class="card-body">
        ...
        <table class="table table-hover table-striped">
            ...
            @forelse ($data->activities()->first()->journals()->orderBy('tanggal_jurnal', 'desc')->paginate(5) as $key
            => $item)
            <tr>
                ...
                <td class="text-center">
                    {{ $data->activities()->first()->journals()->orderBy('created_at', 'desc')->paginate(4)->firstItem()
                    + $key }}
                </td>
                <td class="text-center">
                ...
                <td class="text-center">
                    <a href="{{ route('public.journal.show', ['prefix' => $guard ?? 'web', 'uuid' => $item->uuid]) }}"
