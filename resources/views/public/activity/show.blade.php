    ...
    <div class="card-body">
        <div class="table-responsive">
            ...
            <table class="table table-striped table-hover mb-5">
                ...
                <tr>
                    ...
                    <td>: <strong>{!! ($data->partner()->first()->partner_link_profile) !!} ({{ ($data->status_mitra)
                            }})</strong></td>
                    <td></td>
                    <td></td>
                </tr>
        ...
        <table class="table table-striped table-hover">
            ...
            <tr>
                ...
                <td>: <strong>{!! ($data->student()->first()->student_link_profile) !!}
                        ({{($data->student()->first()->nim_mahasiswa)}})</strong></td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                ...
                <td colspan="3"> :
                    <a href="{{ asset('storage/' . $data->file_laporan_kegiatan) }}"
                        class="btn btn-outline-primary btn-sm" target="_blank">Laporan Kegiatan Mahasiswa</a>
                    <a href="{{ asset('storage/' . $data->file_jurnal_kegiatan) }}"
                        class="btn btn-outline-success btn-sm" target="_blank">File Jurnal Kegiatan</a>
                    <a href="{{ ($data->link_survey ?? url('404')) }}" target="__blank"
                        class="btn btn-outline-warning btn-sm" target="_blank">Link Survey</a>
                    <a href="{{ ($data->file_sk_kegiatan ?? url('404')) }}" target="__blank"
                        class="btn btn-outline-info btn-sm" target="_blank">Download SK</a>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3">
                    ...
                    <a href="{{ asset('storage/' . $data->file_penilaian_kegiatan ?? 'not_found') }}"
                        class="btn btn-success btn-sm" target="_blank">File Penilaian Kegiatan</a>
                    @else
    ...
    <div class="card-body">
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <td><a href="{!! route('public.laporan-kegiatan.show', ['id' => $item->uuid]) !!}"
                        class="btn btn-outline-primary btn-sm">Detail</a></td>
            </tr>
            @endforeach
        </table>
        <div class="row">
